...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (isset($data['title']) && isset($data['description']) && isset($data['due_date'])) {
        ...
        echo json_encode(['message' => 'Missing or invalid data in the request. Ensure title, description, and due_date are provided.']);
    }
    ...
    if (isset($data['title']) && isset($data['description']) && isset($data['due_date'])) {
        ...
        http_response_code(400); // Bad Request
        echo json_encode(['message' => 'Missing or invalid data in the request. Ensure id, title, description, and due_date are provided.']);
    }
